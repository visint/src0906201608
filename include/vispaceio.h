...
/****************************************************************
 * Constants.Note following Constants was move from ccenter
 ****************************************************************/
#define SEMKEY 1235L
...
void updateUnitDate(uchar_t retry);
...
extern int sendMessageToUnit(uchar_t chassis,uchar_t slot,char message[],unsigned int useconds,char is_send_alarm,char from,char is_print);
#endif /* __IO_H */
