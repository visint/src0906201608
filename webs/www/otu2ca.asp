...
function mod_otu2(id,isid,port,iid)
{
 ...
 location.href="/goform/otu2?cid=0&uid=" +document.getElementById("uid").value +"&page=" +"otu2ca.asp" +"&isid=" +isid +"&port=" +port +"&iid=" +iid+"&val=" +val;  
}
</script>
...
<ul id="nav">
  ...
  <li><a href="#" id="otu2ca" name="navitem" class="current" onclick="javascript:toUrl('otu2ca');">交叉矩阵</a></li>
