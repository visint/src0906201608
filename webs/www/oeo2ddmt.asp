...
<ul id="nav">
  ...
  <li><a href="#" id="otu" name="navitem" onclick="javascript:toUrl('oeo2');">OEO 信息</a></li>
  <li><a href="#" id="oeo2ca" name="navitem" onclick="javascript:toUrl('oeo2ca');">交叉矩阵</a></li>
  <li><a href="#" id="ddm" name="navitem" onclick="javascript:toUrl('oeo2ddm');">DDM 信息</a></li>
  <li><a href="#" id="ddmt" name="navitem" class="current" onclick="javascript:toUrl('oeo2ddmt');">DDM 告警阈值</a></li>
  <li><a href="../help/oeo.htm" target="new">帮助</a></li>
</ul>
<div id="content">
<input type="hidden" id="pid" name="page" value="oeo2ddmt"/>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0">
 <tr>
  ...
  <td valign="top">
   ...
   <%DDM(3,2);%>
   <tr>
   <td colspan="12" align="center"><a class="button white medium" href="oeod2ddmt.asp">刷新</a></td>
  </tr>
   </table>   
   </td>
  </tr>
