...
<ul id="nav">
  ...
  <li><a href="#" id="ddmt" name="navitem" class="current" onclick="javascript:toUrl('oeoddmt');">DDM 告警阈值</a></li>
  <li><a href="../help/oeo.htm" target="new">帮助</a></li>
</ul>
<div id="content">
<input type="hidden" id="pid" name="page" value="oeoddmt"/>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0">
 <tr>
  ...
  <td valign="top">
   ...
   <%DDM(10,2);%>
   <tr>
   <td colspan="12" align="center"><a class="button white medium" href="oeoddmt.asp">刷新</a></td>
  </tr>
   </table>   
   </td>
  </tr>
