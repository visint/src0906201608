...
function app(act)
{
  ...
  if (false!=ret)
  {
   ...
   if (2==act)
    {
      //alert("/goform/oss?act=2&cid=0&uid=" +ossForm.uid.value);
...
<ul id="nav">
    ...
    <li><a href="#" id="oss" name="navitem" class="current" onclick="javascript:toUrl('oss');">OSS 通道1信息</a></li>
...
<input type="hidden" id="pid" name="current_page" value="oss.asp">
<input type="hidden" id="chid" name="chid" value="1"/>
...
<div class="uf1"></div>
 ...
 <div class="yui3-u" id="main" style="padding-top:5px;align-text:center;">
        ...
        <div id="ibox" class="ibox">OSS通道1信息</div>
         ...
         <div>
         <input class="button white medium" type="button" value="刷新" onclick="javascript:toUrl('oss');" name="refresh"/><input class="button white medium" type="submit" value="应用" name="apply" />
        </div>
        </div>
       </form>     
    </div>
