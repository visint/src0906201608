...
<ul id="nav">
  ...
  <li><a href="#" id="base" name="navitem"  class="current" onclick="javascript:toUrl('oeobi');">基本信息</a></li>
  <li><a href="#" id="otu" name="navitem" onclick="javascript:toUrl('oeo');">OEO 信息</a></li>
...
<input type="hidden" id="pid" name="page" value="oeobi"/>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0">
 <tr>
   ...
   <td colspan="4" align="center">
    <input class="button white medium" type="button" value="刷新" onclick="window.location.href('oeobi.asp');" name="refresh"/>
