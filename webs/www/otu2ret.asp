...
{ 
  ...
  location.href="/goform/slot?cid=0&uid=" +<%UnitID();%> +"&page=otu2";
}
...
<ul id="nav">
  ...
  <li><a href="#" id="otu" name="navitem" class="current" onclick="javascript:toUrl('otu2');">OTU 信息</a></li>
