...
function mod_otu(id,isid,port,iid)
{
 ...
 location.href="/goform/otu?cid=0&uid=" +document.getElementById("uid").value +"&page=" +"oeoret" +"&isid=" +isid +"&port=" +port +"&iid=" +iid+"&val=" +val;  
}
</script>
<body class="yui3-skin-sam">

<ul id="nav">
  <li><span>OEO(10G)=></span></li>
  <li><a href="#" id="base" name="navitem" onclick="javascript:toUrl('oeobi');">基本信息</a></li>
  <li><a href="#" id="oeo" name="navitem" class="current" onclick="javascript:toUrl('oeo');">OEO 信息</a></li>
  <li><a href="#" id="ddm" name="navitem" onclick="javascript:toUrl('oeoddm');">DDM 信息</a></li>
   <li><a href="#" id="ddmt" name="navitem" onclick="javascript:toUrl('oeoddmt');">DDM 告警阈值</a></li>
  <li><a href="../help/oeo.htm" target="new">帮助</a></li>
</ul>
<div id="content">
<div class="yui3-g" id="bd">
<input type="hidden" id="pid" name="current_page" value="oeo.asp">
...
<div class="uf1"></div>
 ...
 <div class="yui3-u" id="main" style="padding-top:5px;align-text:center;">
        <div id=oeo class="cbox" align='center' style="padding-top:5px;">
        <div class="ibox">OEO信息</div>
         <div class="hbox">
         <%UnitInfo(10,1,1,1);%>
        </div>
         <div>
         <input class="button white medium" type="button" value="刷新" onclick="javascript:toUrl('oeo');" name="refresh"/>
        </div>
        </div>         
    </div>
</div>
