...
<tr>
 <td height="29" colspan="2" align="center">
   <input class="button white medium" type="button" value="刷新" onclick="window.location.href('default.asp');" name="refresh" onsubmit="return check();"/>
    </td>
   <td height="29" colspan="2" align="center">
