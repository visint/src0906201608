...
function mod_otu(id,isid,port,iid)
{
 ...
 location.href="/goform/otu?cid=0&uid=" +document.getElementById("uid").value +"&page=" +"oeo2ret" +"&isid=" +isid +"&port=" +port +"&iid=" +iid+"&val=" +val;  
}
</script>
...
<ul id="nav">
  ...
  <li><a href="#" id="otu2" name="navitem" class="current" onclick="javascript:toUrl('oeo2');">OEO 信息</a></li>
...
<div class="uf1"></div>
 ...
 <div class="yui3-u" id="main" style="padding-top:5px;align-text:center;">
        ...
        <div class="ibox">OEO信息</div>
         ...
         <div>
         <input class="button white medium" type="button" value="刷新" onclick="javascript:toUrl('oeo2');" name="refresh"/>
        </div>
        </div>         
    </div>
</div>
