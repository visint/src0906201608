...
function mod_otu(id,isid,port,iid)
{
 ...
 location.href="/goform/otu?cid=0&uid=" +document.getElementById("uid").value +"&page=" +"otu2ret" +"&isid=" +isid +"&port=" +port +"&iid=" +iid+"&val=" +val;  
}
</script>
...
<ul id="nav">
  ...
  <li><a href="#" id="otu2" name="navitem" class="current" onclick="javascript:toUrl('otu2');">OTU 信息</a></li>
...
<input type="hidden" id="pid" name="current_page" value="otu2.asp">
...
<div class="uf1"></div>
 ...
 <div class="yui3-u" id="main" style="padding-top:5px;align-text:center;">
        ...
        <div class="ibox">OTU信息</div>
         ...
         <div>
         <input class="button white medium" type="button" value="刷新" onclick="javascript:toUrl('otu2');" name="refresh"/>
        </div>
        </div>         
    </div>
</div>
