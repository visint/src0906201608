...
<ul id="nav">
  ...
  <li><a href="syslog.asp" class="current">系统日志</a></li>
  <li><a href="syslogconf.asp">系统日志配置</a></li>
...
<div align="center">
<a class="button white medium"  href="/goform/syslogman?opt=del&id=0" onclick="return opt_ack(10,'操作日志');">删除全部操作日志</a>
</div>
</div>
</body>
</html>
