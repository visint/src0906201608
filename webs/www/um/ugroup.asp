...
<div id="content">
<form name="ugroup" action="/goform/AddGroup" method="POST">
<table border="1" align="center" cellpadding="0" cellspacing="0" class="dt">
  ...
  <tr>
    ...
    <td><INPUT TYPE="checkbox" id="enabled" name="enabled" checked="checked" title="Enabled">启用</td>
    <td><input type="hidden" id="privilege" name="privilege" size="6" value="4"/>
    <INPUT TYPE="checkbox" id ="operate" name="operate" VALUE="add" onclick="javascript:is_add();">添加</td>
  </tr>
</table>
<div align="center">
