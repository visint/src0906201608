...
<ul id="nav">
  ...
  <li><a href="#" id="base" name="navitem" onclick="javascript:toUrl('odmbi');">基本信息</a></li>
  <li><a href="#" id="odm" name="navitem" class="current" onclick="javascript:toUrl('odm');">ODM信息</a></li>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0">
 <tr>
   ...
   <input class="button white medium" type="button" value="刷新" onclick="window.location.href('odm.asp');" name="refresh"/>
   </td>
   </tr>
   </table>
   </td>
