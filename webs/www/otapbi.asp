...
function toUrl(p)   
{ 
	alert("/goform/slot?cid=0&uid=" +otapForm.uid.value +"&page=" +p);
...
<body>
<script language="javascript">
showOtapNav(13,ut,"bi");
</script>
<div id="content">
<form name="otapForm" method="GET" action="/goform/formUD" onsubmit="return checkud();">
<input type="hidden" id="pid" name="page" value="otapbi"/>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0">
 <tr>
   ...
   <td colspan="4" align="center">
    <button class="button white medium" type="button"  onclick="window.location.href('otapbi.asp');" name="refresh">刷新</button> 
