...
<ul id="nav">
  ...
  <li><a href="#" id="base" name="navitem" class="current" onclick="javascript:toUrl('dvoabi');">基本信息</a></li>
  <li><a href="#" id="dvoa" name="navitem" onclick="javascript:toUrl('dvoa');">DVOA 状态信息</a></li>
  <!--<li><a href="#" id="dvoat" name="navitem" onclick="javascript:toUrl('dvoat');">DVOA 告警阈值</a></li>-->
  <li><a href="../help/dvoa.htm" target="new">帮助</a></li>
</ul>
<div id="content">
<form name="dvoaForm" method="GET" action="/goform/formUD" onsubmit="return confirm('你真的要修改DVOA的基本信息?');">
<input type="hidden" id="pid" name="page" value="dvoabi"/>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0">
 <tr>
   ...
   <table border="1" align="center" cellpadding="0" cellspacing="0" class="dt">
     <thead>
   <tr>
     <th colspan="4">DVOA单元盘基本信息</th>
   </tr>
   </thead>
    <%UserData();%>
   <tr>
   <td colspan="4" align="center">
    <input class="button white medium" type="button" value="刷新" onclick="window.location.href('dvoabi.asp');" name="refresh"/>
