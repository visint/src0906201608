...
<tr>
   <td></td>
   <td ALIGN="CENTER"> 
   <input class="button white medium bw" type=submit name=ok value="OK" title="Save Configuration"> <input class="button white medium bw" type=submit name=ok value="Cancel"></td>
</tr>
</table>
</form>
</div>
