...
int asp4u_unit_view(webs_t wp,uchar_t slot,uchar_t uclass,uchar_t utype)
{
 ...
 nBytesSent+=asp4u_unit_ports_view(wp,slot,200,uvi.ports.portCount,uvi.ports.ports_status,uvi.ports.ports_htext,uvi.ports.ports_text,isTxtAtTwoSide, port_img,port_img_size);
