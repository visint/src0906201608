...
/*
static short userLevel=0;
short getUserLevel1()
{
  short privilege=umGetUserPrivilege(char_t *user);
  return userLevel;
}
*/
/*********************************** Code *************************************/
 ...
 */
	...
	bfree(B_L, accessLimit);
        //short ul=umGetUserLevel(userid);
        //if (ul!=userLevel)
        //  userLevel=ul;
        //printf("userid=%s umGetUserLevel=%d\n",userid, umGetUserLevel(userid));
	return nRet;
}
